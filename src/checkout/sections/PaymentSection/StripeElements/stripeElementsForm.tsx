...
export function CheckoutForm() {
	...
	return (
		<form className="my-8 flex flex-col gap-y-6" onSubmit={onSubmitInitialize}>
			...
			<button
				className="h-12 items-center rounded-full bg-brand-600 px-6 py-3 text-base font-semibold uppercase tracking-wide text-white shadow-lg transition hover:bg-brand-700 disabled:cursor-not-allowed disabled:bg-brand-300 disabled:text-white/70 aria-disabled:cursor-not-allowed aria-disabled:opacity-70"
